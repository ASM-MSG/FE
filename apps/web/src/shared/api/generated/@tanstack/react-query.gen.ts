...
import { accept, addHelpful, approve, createComment, delete_, deleteComment, deleteFriend, deleteMe, findMyBadges, getActiveMissionsInViewport, getCell, getCollectionGrids, getComments, getConsentStatus, getDistricts, getEventLocationsByGrid, getExploreRegions, getFriendGridAggregates, getFriendGrids, getFriendGridVideos, getFriendProfile, getFriends, getGridCover, getGridGlobalVideos, getGridHourlyUploads, getGridVideos, getHotZones, getInbox, getLocations, getLocationVideos, getMe, getMissionAggregates, getMissionDetail, getMissionsByGrid, getMissionVideos, getMyFriendCode, getMyProgress, getNationalStat, getOccupiedAggregatesInViewport, getOccupiedInViewport, getOccurrenceDetail, getOccurrencesInViewport, getPlayback, getPreferences, getReceivedRequests, getRegionGrids, getRegionVideos, getReports, getStatByGrid, getStatByPoint, getStats, getSummary, getTrendingKeywords, getUnreadCount, getUploadHistory, getVideoDetail, getVideoForReview, getViewerCount, getZones, heartbeat, highlightPreview, issuePresignedUrl, issueProfileImagePresignedUrl, login, logout, markAllRead, markRead, oauthCodeLogin, oauthLogin, type Options, preview, redirectToKakaoAuthorize, register, reissue, reject, reject1, removeHelpful, removeProfileImage, replace, replaceFeatured, report, request, reverseGeocode, searchPlaces, setVisibility, signup, socialLogin, submitConsents, unblindVideo, unregister, update, updateComment, updateLocationConsent, updateMarketingConsent, updateNickname, updateProfileImage, updateSubscription, upload, upload1, uploadMissionVideo } from '../sdk.gen';
